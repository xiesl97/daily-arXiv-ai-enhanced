...
### [3] [Antarctic TianMu Staring Observation Project I: Overview and Implementation of the Prototype Telescope](https://arxiv.org/abs/2512.24067)
...
### [4] [Antarctic TianMu Staring Observation Project II: Data reduction and preliminary results](https://arxiv.org/abs/2512.24068)
...
### [5] [Connecting disc-corona physics and ionised outflows in AGN in the 2040s](https://arxiv.org/abs/2512.24187)
...
### [6] [From Nbody1 to Nbody7: the Growth of Sverres Industry](https://arxiv.org/abs/2512.24299)
*Rainer Spurzem*
...
### [7] [Picture an Astronomer: Best Practices for Retaining Talent in Astrophysics](https://arxiv.org/abs/2512.24465)
...
### [8] [Nine years of UVIT: assessing sensitivity variation](https://arxiv.org/abs/2512.24475)
...
### [9] [Understanding Solar Flares and Energetic Events: Open questions, observational requirements, and instrumental needs over the coming decade](https://arxiv.org/abs/2512.24479)
...
### [10] [AstroReview: An LLM-driven Multi-Agent Framework for Telescope Proposal Peer Review and Refinement](https://arxiv.org/abs/2512.24754)
...
### [11] [LUNCH: A Lightweight Unified Deep-Learning Framework for General Transients Classification in High-Energy Time-Domain Astronomy](https://arxiv.org/abs/2512.24764)
...
### [12] [TTC: Transformer-based TDE Classifier for the Wide Field Survey Telescope (WFST)](https://arxiv.org/abs/2512.24782)
...
### [13] [Resolving the Origins and Pathways of Ionizing Radiation Escape with UV Integral Field Spectroscopy](https://arxiv.org/abs/2512.24895)
...
### [14] [A clustering-based search for substructures in the Galactic plane and bulge using RR Lyrae stars as tracers](https://arxiv.org/abs/2512.23846)
...
### [15] [The ionization structure and chemical history in isolated H ii regions of dwarf galaxies with VIMOS/IFU II. The Leo A galaxy](https://arxiv.org/abs/2512.23863)
...
### [16] [Variation of the 2175 Å extinction feature in Andromeda galaxy](https://arxiv.org/abs/2512.23958)
...
### [17] [photoD with Rubin's Data Preview 1: first stellar photometric distances and deficit of faint blue stars. Stellar distances with Rubin's DP1](https://arxiv.org/abs/2512.24109)
...
### [18] [A Convolutional Neural Network for the Recovery of Transfer Functions From Velocity-Resolved Reverberation Mapping Data](https://arxiv.org/abs/2512.24433)
...
### [19] [Dust destruction in bubbles driven by multiple supernovae explosions](https://arxiv.org/abs/2512.24670)
...
### [20] [Destruction of the interstellar dust by a supernova](https://arxiv.org/abs/2512.24677)
*Evgenii O. Vasiliev*
...
### [21] [Scalable Stellar Parameter Inference Using Python-based LASP: From CPU Optimization to GPU Acceleration](https://arxiv.org/abs/2512.24840)
...
### [22] [Machine-Learning Classification of Neutron-Star Matter Composition from Macroscopic and Oscillation Observables](https://arxiv.org/abs/2512.23758)
*Wasif Husain*
...
### [25] [Machine-learning approaches to dispersion measure estimation for fast radio bursts](https://arxiv.org/abs/2512.24003)
...
### [26] [SSC Radiation in the ICMART Model: Spectral Simulations and Application to the Record-Breaking GRB 221009A](https://arxiv.org/abs/2512.24085)
*Xueying Shao,He Gao*
...
### [27] [Evolution of Accretion Properties in Mrk 1040 using long-term X-ray Observations](https://arxiv.org/abs/2512.24141)
...
### [28] [A Seyfert galaxy as a hidden counterpart to a neutrino-associated blazar](https://arxiv.org/abs/2512.24178)
...
### [29] [Abundance Stratification in Type Iax SN 2020rea with TARDIS](https://arxiv.org/abs/2512.24203)
...
### [30] [H.E.S.S. detection and multi-wavelength study of the $z \sim$ 1 blazar PKS 0346$-$27](https://arxiv.org/abs/2512.24228)
...
### [31] [Improved lanthanide constraints for the kilonova AT 2017gfo](https://arxiv.org/abs/2512.24257)
...
### [32] [Evidence for the transition from thermal to non-thermal emission in the prompt emission of GRB 161117A](https://arxiv.org/abs/2512.24563)
...
### [33] [The role of PSR J0614-3329 in defining the high-density matter at Neutron star cores](https://arxiv.org/abs/2512.24729)
...
### [34] [Searching for Periodicity in FRB 20240114A](https://arxiv.org/abs/2512.24936)
*J. I. Katz*
...
### [35] [Multi-Frequency Study of FRB20201124A with the uGMRT](https://arxiv.org/abs/2512.24978)
...
### [36] [Tidally Trapped Two-pole Pulsations Discovered in a Close Binary with a Massive $β$ Cephei Star](https://arxiv.org/abs/2512.24185)
...
### [37] [The Likelihood of Hosting Undetected Brown Dwarfs in the Solar Vicinity](https://arxiv.org/abs/2512.24319)
...
### [38] [Turbulence-Driven Corrugation of Collisionless Fast-Magnetosonic Shocks](https://arxiv.org/abs/2512.24425)
...
### [39] [A millimeter methanol maser ring tracing the deceleration of the heat wave powered by the massive protostellar accretion outburst in G358.93-0.03 MM1](https://arxiv.org/abs/2512.24380)
...
### [40] [A closer look at the young stellar group around Sh 2-295](https://arxiv.org/abs/2512.24388)
...
### [41] [3D Radiative MHD Modeling of Particle Beam Heating of the Solar Atmosphere](https://arxiv.org/abs/2512.24507)
...
### [42] [Inferring Solar Magnetic fields From the Polarization of the Mg II h and k Lines](https://arxiv.org/abs/2512.24578)
...
### [43] [Coronal flux tube illuminated by strong shock spot: New Year's Eve solar eruption of 2023-Dec-31](https://arxiv.org/abs/2512.24749)
...
### [44] [Distributions of wide binary stars in theory and in Gaia data: III. Orbital momenta, masses, and manifestations of MOND](https://arxiv.org/abs/2512.25002)
*Valeri V. Makarov*
...
### [45] [Clustering of cosmic string loops within a Milky-way like halo](https://arxiv.org/abs/2512.23811)
...
### [46] [The Tianlai-WIYN North Celestial Cap Redshift Survey](https://arxiv.org/abs/2512.23899)
...
### [47] [$S_8-H_0$ tension in a SI-ULDM scenario](https://arxiv.org/abs/2512.24309)
...
### [48] [Self-Gravitating Scalar Field Configurations, Ultra Light Dark Matter and Galactic Scale Observations](https://arxiv.org/abs/2512.24350)
*Bihag Dave*
...
### [49] [Integrated Sachs-Wolfe maps from the Gower Street $w$CDM simulations](https://arxiv.org/abs/2512.24369)
...
### [50] [OmniCosmos: Transferring Particle Physics Knowledge Across the Cosmos](https://arxiv.org/abs/2512.24422)
...
### [51] [An Effective Theory for Biased Tracers via the Boltzmann-Equation Approach](https://arxiv.org/abs/2512.24672)
...
### [52] [Cosmological dynamics and observational constraints of an interacting early scalar field coupled to radiation](https://arxiv.org/abs/2512.24918)
...
### [53] [Cosmic Himalayas in CROCODILE : Probing the Extreme Quasar Overdensities by Count-in-Cells analysis and Nearest Neighbor Distribution](https://arxiv.org/abs/2512.24966)
...
### [54] [Towards precision cosmology with Voids x CMB correlations (I): Roman-Agora mock catalogs and pipeline validation](https://arxiv.org/abs/2512.25040)
...
### [55] [Feeling Blue: Constructing a Robust SALT3 UV Template and Constraining its Redshift Dependency](https://arxiv.org/abs/2512.25064)
