...
### [9] [Search for gamma-ray variability around Fermi-LAT pulsar glitches](https://arxiv.org/abs/2601.03939)
...
### [10] [Exploring the potential for ultra-relativistic jets in Scorpius X-1 with low angular resolution radio observations](https://arxiv.org/abs/2601.03962)
...
### [11] [Satellite-borne γ-ray astrophysics from coherent interactions in oriented crystals](https://arxiv.org/abs/2601.04129)
...
### [12] [Implications of Non-equatorial Relativistic Accretion Flows for Ultra-Fast Inflows in AGNs](https://arxiv.org/abs/2601.04141)
...
### [13] [A spectroscopically confirmed, strongly lensed, metal-poor Type II supernova at z = 5.13](https://arxiv.org/abs/2601.04156)
...
### [14] [GRB 180728A and SN 2018fip: the nearest high-energy cosmological gamma-ray burst with an associated supernova](https://arxiv.org/abs/2601.04179)
...
### [15] [Non-thermal particle acceleration in multi-species kinetic plasmas: universal power-law distribution functions and temperature inversion in the solar corona](https://arxiv.org/abs/2601.03344)
...
### [16] [The SOL $\textit{(Solar Origin and Life)}$ Project: Detailed characterization of candidates for the ZAMS and Subgiant stages](https://arxiv.org/abs/2601.03350)
...
### [17] [Perhaps there is no brown dwarf desert? A study of sub-stellar companions with Gaia DR3](https://arxiv.org/abs/2601.03539)
...
### [18] [Electron Cyclotron Maser Emission from Ejected Stellar Prominences on V374 Peg](https://arxiv.org/abs/2601.03568)
...
### [19] [Investigating the Center-to-Limb Effects in Helioseismic Data Using 3D Radiative Hydrodynamic Simulations](https://arxiv.org/abs/2601.03650)
*Irina N. Kitiashvili*
...
### [20] [A Multiband Photometric Study of RR Lyrae Stars in M53 (NGC 5024)](https://arxiv.org/abs/2601.03758)
...
### [21] [The massive hot subdwarf binary LAMOST J065816.72+094343.1](https://arxiv.org/abs/2601.03810)
...
### [22] [The Gaia All-Sky Stellar Parameters Service (GASPS)](https://arxiv.org/abs/2601.03978)
...
### [23] [Dissecting the dust distribution and polarization around two B213 young stellar objects with ALMA](https://arxiv.org/abs/2601.04091)
...
### [24] [Characterizing the physical and chemical properties of the Class I protostellar system Oph-IRS 44. Binarity, infalling streamers, and accretion shocks](https://arxiv.org/abs/2601.04108)
...
### [25] [Radio Activity from the Rapidly Rotating T dwarf 2MASS 2228-4310](https://arxiv.org/abs/2601.04158)
...
### [26] [Local simulations of common-envelope dynamical inspiral. Impact of rotation, accretion, and stratification](https://arxiv.org/abs/2601.04188)
...
### [27] [Simulation-Based Inference for Probabilistic Galaxy Detection and Deblending](https://arxiv.org/abs/2601.03422)
...
### [28] [MARVEL: A Multi Agent-based Research Validator and Enabler using Large Language Models](https://arxiv.org/abs/2601.03436)
...
### [29] [Modelling spacecraft-emitted electrons measured by SWA-EAS experiment on board Solar Orbiter mission](https://arxiv.org/abs/2601.03818)
...
### [30] [Polarization rotation through differential transmission in refractive CMB telescopes identified using a hybrid physical optics method](https://arxiv.org/abs/2601.03925)
...
### [31] [Science with a large field-of-view polarization survey: The Large Array Survey Telescope Polarization Node (LAST-P)](https://arxiv.org/abs/2601.03921)
...
### [32] [Can Dynamic Spectrum Sharing Protect Passive Radio Sciences?](https://arxiv.org/abs/2601.03966)
*Gregory Hellbourg*
...
### [33] [Fast rotations in galaxies at cosmic noon indicate central concentration of stars, dark matter or massive black holes](https://arxiv.org/abs/2601.03338)
...
### [34] [Early thin-disc assembly revealed by JWST edge-on galaxies](https://arxiv.org/abs/2601.03339)
...
### [35] [Integral field spectroscopy and numerical simulations of the NGC 2207/IC 2163 system](https://arxiv.org/abs/2601.03421)
...
### [36] [Time-dependent chemical evolution during cloud formation: H$_2$-regulated chemistry in diffuse molecular cloud](https://arxiv.org/abs/2601.03441)
...
### [37] [Particle Acceleration and Depolarization in the Protostellar jet knots HH 80 and HH 81](https://arxiv.org/abs/2601.03611)
...
### [38] [An Enhanced Sample of Galactic Red Supergiants Reveals Spiral Structures](https://arxiv.org/abs/2601.03642)
...
### [39] [Predicting dust temperature from molecular line data using machine learning](https://arxiv.org/abs/2601.03680)
...
### [40] [Identification of solid N2O in interstellar ices using open JWST data](https://arxiv.org/abs/2601.03705)
...
### [41] [HST+IGRINS synergy to characterise the newly discovered metal-rich bulge globular cluster Patchick 126](https://arxiv.org/abs/2601.03901)
...
### [42] [Stellar-mass black holes on the millimetre fundamental plane of black hole accretion](https://arxiv.org/abs/2601.04007)
...
### [43] [HI-bearing dark galaxies predictions from constrained Local Group simulations: how many and where to find them](https://arxiv.org/abs/2601.04024)
...
### [44] [Spiral galaxies with flat radial abundance gradients at large radii](https://arxiv.org/abs/2601.04059)
...
### [45] [Modeling the Effect of C/O Ratio on Complex Carbon Chemistry in Cold Molecular Clouds](https://arxiv.org/abs/2601.04103)
...
### [46] [A census of star-formation and gas mass tracers in two lensed $z \sim 4$ dusty star-forming galaxies](https://arxiv.org/abs/2601.04133)
...
### [47] [Towards an optimal extraction of cosmological parameters from galaxy cluster surveys using convolutional neural networks](https://arxiv.org/abs/2601.03894)
...
### [48] [Cosmological constraints on viable $f(R)$ models using weak lensing](https://arxiv.org/abs/2601.04048)
...
### [49] [Estimation of the tidal heating in the TRAPPIST-1 planets. Influence of the internal structure](https://arxiv.org/abs/2601.03408)
...
### [50] [Protonic thermoelectric effect of Superionic H2O and magnetic field generation in Uranus and Neptune](https://arxiv.org/abs/2601.03659)
...
### [51] [The uncertainty in water mass fraction of wet planets](https://arxiv.org/abs/2601.03932)
*Michael Lozovsky*
...
### [52] [Broadband spectroscopy of astrophysical ice analogues: IV. Optical constants of N$_2$ ice in the terahertz and mid-infrared ranges](https://arxiv.org/abs/2601.03951)
...
### [53] [Formation of multi-planetary systems via pebble accretion in externally photoevaporating discs in stellar clusters](https://arxiv.org/abs/2601.03963)
...
### [54] [Investigation of the dynamics and origin of the NEA pair 2021 PH27 and 2025 GN1](https://arxiv.org/abs/2601.03990)
...
### [55] [Two-source terrestrial planet formation with a sweeping secular resonance](https://arxiv.org/abs/2601.04032)
...
### [56] [Secular Excitation of Polar Neptune Orbits in Pure Disk-Planet Systems](https://arxiv.org/abs/2601.04140)
...
### [57] [Disc fragmentation. II. Ejection of low mass Free Floating Planets from growing binary systems](https://arxiv.org/abs/2601.03820)
