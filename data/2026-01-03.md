...
### [6] [Dust destruction in bubbles driven by multiple supernovae explosions](https://arxiv.org/abs/2512.24670)
...
### [7] [Destruction of the interstellar dust by a supernova](https://arxiv.org/abs/2512.24677)
*Evgenii O. Vasiliev*
...
### [8] [Scalable Stellar Parameter Inference Using Python-based LASP: From CPU Optimization to GPU Acceleration](https://arxiv.org/abs/2512.24840)
...
### [9] [Clustering of cosmic string loops within a Milky-way like halo](https://arxiv.org/abs/2512.23811)
...
### [10] [The Tianlai-WIYN North Celestial Cap Redshift Survey](https://arxiv.org/abs/2512.23899)
...
### [11] [$S_8-H_0$ tension in a SI-ULDM scenario](https://arxiv.org/abs/2512.24309)
...
### [12] [Self-Gravitating Scalar Field Configurations, Ultra Light Dark Matter and Galactic Scale Observations](https://arxiv.org/abs/2512.24350)
*Bihag Dave*
...
### [13] [Integrated Sachs-Wolfe maps from the Gower Street $w$CDM simulations](https://arxiv.org/abs/2512.24369)
...
### [14] [OmniCosmos: Transferring Particle Physics Knowledge Across the Cosmos](https://arxiv.org/abs/2512.24422)
...
### [15] [An Effective Theory for Biased Tracers via the Boltzmann-Equation Approach](https://arxiv.org/abs/2512.24672)
...
### [16] [Cosmological dynamics and observational constraints of an interacting early scalar field coupled to radiation](https://arxiv.org/abs/2512.24918)
...
### [17] [Cosmic Himalayas in CROCODILE : Probing the Extreme Quasar Overdensities by Count-in-Cells analysis and Nearest Neighbor Distribution](https://arxiv.org/abs/2512.24966)
...
### [18] [Towards precision cosmology with Voids x CMB correlations (I): Roman-Agora mock catalogs and pipeline validation](https://arxiv.org/abs/2512.25040)
...
### [19] [Feeling Blue: Constructing a Robust SALT3 UV Template and Constraining its Redshift Dependency](https://arxiv.org/abs/2512.25064)
...
### [20] [Machine-Learning Classification of Neutron-Star Matter Composition from Macroscopic and Oscillation Observables](https://arxiv.org/abs/2512.23758)
*Wasif Husain*
...
### [21] [COBIPLANE: A Systematic Search for Compact Binary Millisecond Pulsars at Low Galactic Latitudes](https://arxiv.org/abs/2512.23815)
...
### [22] [Time-Dependent Accretion Disks with Magnetically Driven Winds: Green's Function Solutions](https://arxiv.org/abs/2512.23999)
*Mageshwaran Tamilan*
...
### [23] [Machine-learning approaches to dispersion measure estimation for fast radio bursts](https://arxiv.org/abs/2512.24003)
...
### [24] [SSC Radiation in the ICMART Model: Spectral Simulations and Application to the Record-Breaking GRB 221009A](https://arxiv.org/abs/2512.24085)
*Xueying Shao,He Gao*
...
### [25] [Evolution of Accretion Properties in Mrk 1040 using long-term X-ray Observations](https://arxiv.org/abs/2512.24141)
...
### [26] [A Seyfert galaxy as a hidden counterpart to a neutrino-associated blazar](https://arxiv.org/abs/2512.24178)
...
### [27] [Abundance Stratification in Type Iax SN 2020rea with TARDIS](https://arxiv.org/abs/2512.24203)
...
### [28] [H.E.S.S. detection and multi-wavelength study of the $z \sim$ 1 blazar PKS 0346$-$27](https://arxiv.org/abs/2512.24228)
...
### [29] [Improved lanthanide constraints for the kilonova AT 2017gfo](https://arxiv.org/abs/2512.24257)
...
### [30] [Evidence for the transition from thermal to non-thermal emission in the prompt emission of GRB 161117A](https://arxiv.org/abs/2512.24563)
...
### [31] [The role of PSR J0614-3329 in defining the high-density matter at Neutron star cores](https://arxiv.org/abs/2512.24729)
...
### [32] [Searching for Periodicity in FRB 20240114A](https://arxiv.org/abs/2512.24936)
*J. I. Katz*
...
### [33] [Multi-Frequency Study of FRB20201124A with the uGMRT](https://arxiv.org/abs/2512.24978)
...
### [34] [Tidally Trapped Two-pole Pulsations Discovered in a Close Binary with a Massive $β$ Cephei Star](https://arxiv.org/abs/2512.24185)
...
### [35] [The Likelihood of Hosting Undetected Brown Dwarfs in the Solar Vicinity](https://arxiv.org/abs/2512.24319)
...
### [36] [A millimeter methanol maser ring tracing the deceleration of the heat wave powered by the massive protostellar accretion outburst in G358.93-0.03 MM1](https://arxiv.org/abs/2512.24380)
...
### [37] [A closer look at the young stellar group around Sh 2-295](https://arxiv.org/abs/2512.24388)
...
### [39] [3D Radiative MHD Modeling of Particle Beam Heating of the Solar Atmosphere](https://arxiv.org/abs/2512.24507)
...
### [40] [Inferring Solar Magnetic fields From the Polarization of the Mg II h and k Lines](https://arxiv.org/abs/2512.24578)
...
### [41] [Coronal flux tube illuminated by strong shock spot: New Year's Eve solar eruption of 2023-Dec-31](https://arxiv.org/abs/2512.24749)
...
### [42] [Distributions of wide binary stars in theory and in Gaia data: III. Orbital momenta, masses, and manifestations of MOND](https://arxiv.org/abs/2512.25002)
*Valeri V. Makarov*
...
### [43] [Atmospheric Mass Flux as a Function of Ionospheric Emission on Unmagnetized Earth](https://arxiv.org/abs/2512.24004)
...
### [44] [Seafloor Weathering and Stochastic Outgassing Unlikely to Significantly Shorten the Future Lifespan of Earth's Terrestrial Biosphere](https://arxiv.org/abs/2512.24538)
...
### [45] [Antarctic TianMu Staring Observation Project I: Overview and Implementation of the Prototype Telescope](https://arxiv.org/abs/2512.24067)
...
### [46] [Antarctic TianMu Staring Observation Project II: Data reduction and preliminary results](https://arxiv.org/abs/2512.24068)
...
### [47] [Connecting disc-corona physics and ionised outflows in AGN in the 2040s](https://arxiv.org/abs/2512.24187)
...
### [48] [From Nbody1 to Nbody7: the Growth of Sverres Industry](https://arxiv.org/abs/2512.24299)
*Rainer Spurzem*
...
### [49] [Picture an Astronomer: Best Practices for Retaining Talent in Astrophysics](https://arxiv.org/abs/2512.24465)
...
### [50] [Nine years of UVIT: assessing sensitivity variation](https://arxiv.org/abs/2512.24475)
...
### [51] [Understanding Solar Flares and Energetic Events: Open questions, observational requirements, and instrumental needs over the coming decade](https://arxiv.org/abs/2512.24479)
...
### [52] [AstroReview: An LLM-driven Multi-Agent Framework for Telescope Proposal Peer Review and Refinement](https://arxiv.org/abs/2512.24754)
...
### [53] [LUNCH: A Lightweight Unified Deep-Learning Framework for General Transients Classification in High-Energy Time-Domain Astronomy](https://arxiv.org/abs/2512.24764)
...
### [54] [TTC: Transformer-based TDE Classifier for the Wide Field Survey Telescope (WFST)](https://arxiv.org/abs/2512.24782)
...
### [55] [Resolving the Origins and Pathways of Ionizing Radiation Escape with UV Integral Field Spectroscopy](https://arxiv.org/abs/2512.24895)
